                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->no_rm == true) { ?>
                                            <input type="text" class="form-control" name="rm" value="<?php echo $u->no_rm ?>">
                                        <?php
                                        } else { ?>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->nama == true) { ?>
                                            <input style="text-transform: capitalize;" type="text" class="form-control" name="nama" value="<?php echo $u->nama ?>">
                                        <?php
                                        } else { ?>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->tgl_lahir == true) { ?>
                                            <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?php echo $u->tgl_lahir ?>">
                                        <?php
                                        } else { ?>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->alamat == true) { ?>
                                            <textarea style="text-transform: capitalize;" id="alamat" class="form-control" name="alamat" placeholder="Masukkan Alamat" rows="2"><?php echo $u->alamat ?></textarea>
                                        <?php
                                        } else { ?>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->tinggi_badan == true) { ?>
                                            <input style="text-transform: capitalize;" type="number" id="tb" class="form-control" name="tb" value="<?php echo $u->tinggi_badan ?>">
                                        <?php
                                        } else { ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->berat_badan == true) { ?>
                                            <input style="text-transform: capitalize;" type="number" id="bb" class="form-control" name="bb" value="<?php echo $u->berat_badan ?>">
                                        <?php
                                        } else { ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php if ($u->suhu_badan == true) { ?>
                                            <input style="text-transform: capitalize;" type="number" id="sh" class="form-control" name="sb" value="<?php echo $u->suhu_badan ?>">
                                        <?php
                                        } else { ?>
